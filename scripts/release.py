...
Prerequisites:
  ...
  3. Ensure working directory is clean (commit any changes first)
    ...
    parser.add_argument(
        "--version", required=True, help="New version number (semantic versioning, e.g., 0.3.1)"
    )

    parser.add_argument("--message", help="Optional commit/changelog message describing changes")
