...
**Test Status:** 6187 tests collected (95% coverage)
**Python:** 3.9 – 3.13
...
├── tests/                      # Test suite (6187 tests, 95% coverage)
│   ├── agent/                  # Agent tests
│   ├── rag/                    # RAG tests
│   ├── tools/                  # Tool tests
...
### 🧪 **Testing**
- Increase test coverage (currently 6187 tests collected!)
